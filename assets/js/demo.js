...
demo = {
    ...
    initStatsDashboard: function(){
        ...
        var data = {
          ...
          series: [
            ...
            [234, 465, 745, 325, 450, 657, 400, 210, 442, 900, 800, 700]
          ]
        };
        ...
        Chartist.Line('#chartMain', data, options, responsiveOptions);
    ...
    initChartsPage: function(){
        ...
        var data = {
          labels: ['Bridgestone', 'Michelin', 'GT-Radial', 'Swallow', 'Dunlop'],
          series: [
            [542, 443, 320, 780, 553],
            [412, 243, 280, 580, 453],
            [542, 443, 320, 780, 553],
        ...
        Chartist.Line('#chartDay', dataStock, optionsStock);
